...
import { collection, getFirestore, query, where, getDoc, getDocs } from 'firebase/firestore'
...
function FindEmail() {
  ...
  return (
    ...
    {
      isModalOpen &&
       <Modal error={message} onClose={()=>{setModalOpen(false)}}/>
    }
    </>
  )
}
